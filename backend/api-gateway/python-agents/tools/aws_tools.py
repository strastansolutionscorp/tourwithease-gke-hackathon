...
class HotelSearchTool(AWSLambdaTool):
    ...
    async def execute(self, city_code: str, check_in: str, check_out: str, 
                     guests: int = 1, rooms: int = 1, hotel_type: str = None) -> Dict[str, Any]:
        """Execute hotel search"""
        payload = {
            "city_code": city_code,
            "check_in": check_in,
        ...
        try:
            ...
            logger.error(f"HotelSearchTool failed: {e}", exc_info=True)
            return {
                "status": "error",
                "message": str(e),
                "search_criteria": payload
...
class BookingCreationTool(AWSLambdaTool):
    ...
    async def execute(self, booking_type: str, booking_details: Dict[str, Any], 
                     passenger_info: Dict[str, Any]) -> Dict[str, Any]:
        """Execute booking creation"""
        payload = {
            "booking_type": booking_type,
            "booking_details": booking_details,
        ...
        try:
            ...
            logger.error(f"BookingCreationTool failed: {e}", exc_info=True)
            return {
                "status": "error",
                "message": str(e),
                "booking_details": payload
...
class PriceAnalysisTool(Tool):
    ...
    async def execute(self, options: List[Dict[str, Any]], 
